...
- Kevin likes roughly two feet tall (609.6 mm) as a working size, not a fixed requirement. For initial proportions, treat this as assembled height including the base; that measurement convention is a planning assumption. Keep overall size adjustable and reevaluate joints, wall thickness, and socket clearances when resizing rather than uniformly scaling validated interfaces.
